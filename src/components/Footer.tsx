...
export default function Footer() {
  return (
    <footer className="mt-auto bg-gradient-to-br from-rose-deep-800 to-ink pt-12 pb-6 text-white">
      <div className="mx-auto max-w-7xl px-6">
        <div className="mb-8 grid grid-cols-1 gap-8 md:grid-cols-4">
          <div className="text-center md:text-left">
            <div className="mb-4 flex items-center justify-center space-x-3 md:justify-start">
              ...
              />
              <div>
                <p className="font-serif text-xl font-bold text-blush-100">Hamper Heaven</p>
          ...
          <div className="text-center md:text-left">
            ...
            <div className="flex justify-center space-x-4 md:justify-start">
              <a
                ...
                className="flex h-10 w-10 items-center justify-center rounded-full bg-blush-100/20 transition hover:scale-110 hover:bg-blush-100/40"
              >
        ...
        <div className="mb-6 grid grid-cols-1 gap-4 rounded-xl border border-blush-100/30 bg-blush-100/10 p-6 text-sm text-blush-100 md:grid-cols-2">
          <p>Note: We do not have any return policy.</p>
          <p>Note: We require at least 5 days to make products.</p>
        </div>

        <div className="flex flex-col items-center justify-between border-t border-blush-100/20 pt-6 md:flex-row">
