        ...
        <div className="mt-10 grid w-full grid-cols-1 gap-8 lg:grid-cols-2">
          ...
          <div className="flex flex-col items-center justify-center rounded-2xl border border-cream-200 bg-white p-8">
            ...
            <button
              ...
              className="rounded-full bg-gradient-to-r from-rose-deep to-rose-deep-600 px-8 py-3 text-base font-bold text-white shadow-md transition-all duration-200 hover:-translate-y-0.5 hover:shadow-xl hover:brightness-110 active:translate-y-0 active:scale-95"
            >
              Start My Custom Gift
            </button>
            <a
              href={whatsappLink(
                "Hi Hamper Haven! I want a custom gift hamper. Here are my requirements:",
              )}
              target="_blank"
              rel="noopener noreferrer"
              className="mt-3 inline-flex items-center gap-2 rounded-full bg-green-600 px-8 py-3 text-base font-bold text-white shadow-md transition-all duration-200 hover:-translate-y-0.5 hover:bg-green-700 hover:shadow-xl active:translate-y-0 active:scale-95"
            >
